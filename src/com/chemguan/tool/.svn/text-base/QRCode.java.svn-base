...
public class QRCode {
	...
	public static void main(String[] args) throws Exception{
		   String text =  "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx335113c538e4d257&redirect_uri=xiguashu.jiriweb.com/getCode.do&response_type=code&scope=snsapi_base&state=STATE#wechat_redirect";
           String path = "D:/";
           int width = 900;
           int height = 900;
           // 二维码图片格式
	...
	public void test(HttpServletResponse response,String id) throws Exception{
		  String text = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx38b32f527759debd&redirect_uri=http%3A%2F%2Fxiguashu.jiriweb.com%2FgetUser.do&response_type=code&scope=snsapi_userinfo&state="+id+"#wechat_redirect";
		  String path = "D:/";																						
          int width = 297;
          int height = 297;
          // 二维码图片格式
