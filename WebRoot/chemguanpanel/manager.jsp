...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 管理功能</a>
  <ul>
	<li class="submenu"><a href="#"><span>管理员列表</span></a>
...
<div class="widget-box">
     ...
     <td style="text-align: center;"><a href="findManagerById.do?id=${i.id}">修改</a>|
     <a href="deleteManagerById.do?id=${i.id}" onclick="return del()">删除</a></td> 
     </tr>
     </c:forEach>
            </table>
            </div>
