...
<div class="widget-box">
          ...
          <div class="widget-title"> <span class="icon">
            ...
            <h5>全选</h5>   
            <a href="chemguanpanel/addProductsType.jsp">
            <button  class="btn btn-info" type="button" style="float: right; margin-top: 3px;margin-right: 3px;">添加产品类型</button></a>
      ...
      <tr style="font-size: 12px;">
     	...
     	<a href="afterUpdateProductTypeUI.do?id=${i.id}">修改</a>|
    	<a href="afterDeleteProductType.do?id=${i.id}" onclick="return del()">删除</a>
    	</td> 
     </tr>
     </c:forEach>
            </table>
...
<!-- ************************************************************************************************************************************************* -->
			...
			<%@include file="pageView.jsp" %>
				<form action="afterFindProductType.do"  id="pageForm">
