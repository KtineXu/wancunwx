...
<div class="container-fluid">
        ...
        <c:if test="${producttype.id==null}">
        	<form id="form1" class="form-horizontal" action="afterInserProductType.do" method="post" enctype="multipart/form-data">
        </c:if>
        <c:if test="${producttype.id!=null}">
        	<form class="form-horizontal" id="form1" action="afterUpdateProductType.do" method="post" enctype="multipart/form-data">
        	<input type="hidden" value="${producttype.id}"  name="id"/>
        </c:if>
            
            
            <div class="control-group">
              <label class="control-label">产品类型名称:</label>
              <div class="controls">
                <input type="text" value="${producttype.typename}"  style="height:30px;width:300px"   name="productName" id="name">
            </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
              	<textarea rows="10" cols="150" name="description">${producttype.description}</textarea>
            	</div>
            </div>
