...
<div id="content">
  <!--from表单  -->
     <div class="container-fluid">
        ...
        <form class="form-horizontal" id="form1" action="behindInsertProgress.do" method="post" >
        	<input type="hidden" value="${repairId }" name="repairId"/>
           <div class="control-group">
              <label class="control-label">进度描述：</label>
              <div class="controls">
