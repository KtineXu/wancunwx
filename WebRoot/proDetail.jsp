...
<!--loading页结束-->
	<body>
	    ...
	    <div id="main" class="mui-clearfix">
	    	<div class="banner swiper-container">
	            <div class="swiper-wrapper">
	                <div class="swiper-slide"><a href="javascript:void(0)"><img class="swiper-lazy" data-src="upload/rou1.jpg" alt=""></a></div>
	               </div>
	        ...
	        <div class="inte-top clearfloat box-s">
	        	<div class="left clearfloat fl">
	        		<p class="tit">黑猪月牙肉</p>
	        		<p class="price"><span>500</span>元<samp>￥208元</samp></p>
	        	</div>
	    ...
	    <footer class="page-footer fixed-footer" id="footer">
	     	<a href="shopcar.jsp" class="shopcaradd fl">
	     		加入购物车
	     	</a>
	     	<a href="confirm.jsp" class="ljdhuan fl">
	     		立即购买
	     	</a>
	    </footer>
	</body>
